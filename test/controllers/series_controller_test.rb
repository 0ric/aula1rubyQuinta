...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Serie.count") do
      post series_url, params: { series: { DataDeLancamento: @series.DataDeLancamento, description: @series.description, diretor: @series.diretor, episodio: @series.episodio, nome: @series.nome } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { DataDeLancamento: @series.DataDeLancamento, description: @series.description, diretor: @series.diretor, episodio: @series.episodio, nome: @series.nome } }

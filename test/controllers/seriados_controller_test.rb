...
class SeriadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seriado" do
    assert_difference("Seriado.count") do
      post seriados_url, params: { seriado: { DataDeLancamento: @seriado.DataDeLancamento, description: @seriado.description, diretor: @seriado.diretor, episodio: @seriado.episodio, nome: @seriado.nome } }
    end
  ...
  test "should update seriado" do
    patch seriado_url(@seriado), params: { seriado: { DataDeLancamento: @seriado.DataDeLancamento, description: @seriado.description, diretor: @seriado.diretor, episodio: @seriado.episodio, nome: @seriado.nome } }
